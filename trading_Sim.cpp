...
public:
    Market() {
        stocks.push_back(Stock("Adani", Normdist(100,3)));
        stocks.push_back(Stock("TATA", Normdist(150,3)));
        stocks.push_back(Stock("Reliance",Normdist(50,3)));
    }
    void pricechange() {
...
int main() {
    ...
    do {
        ...
        if (choice == '1') {
            ...
            cout << "Enter stock index to buy (0: Adani, 1: TATA, 2: Reliance): ";
            cin >> stocknum;
            ...
            int stocknum, quantity;
            cout << "Enter stock index to sell (0: Adani, 1: TATA, 2: Reliance): ";
            cin >> stocknum;
            if(stocknum<0 || stocknum>=3){cout << "Invalid stock index"<<endl;continue;}
            cout << "Enter quantity: ";
            cin >> quantity;
